...
The data sets that I used were compiled by Samarth Bansal at the Hindustan Times. The .csv files can be found on [Github](https://github.com/HindustanTimesLabs/women-empowerment-index/tree/master/data).
...
I downloaded the .csv files and imported them to Google Sheets where I interrogated the data for interesting trends or finds. I realized that the best way to understand this data was to visualize it. I created choropleth maps for each of the eight indicators of Women Empowerment and Gender-Based Violence that the Indian Ministry of Health and Family Welfare decided to collect data on. I chose to use [Datawrapper](datawrapper.de) to create the choropleth maps, but before I could create them, I had to clean the data to match the Datawrapper qualifications. 
...
After creating the choropleth maps, I was able to continue my analysis of the data visually. I wanted to see if there were regional trends in any of the indicators. I found that three indicators showed regional trends.
...
#### 3. Higher percentages of married women have experienced spousal violence in the Southeast compared to the Northwest. 
